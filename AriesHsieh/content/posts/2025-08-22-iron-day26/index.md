...
時間來到了第 26 天，App「台灣公路 K 點通」(對，取名了XD) 核心功能已大致完成，是時候著手建立一套自動化的 CI/CD (持續整合/持續部署) 流程了。預想目標是，當推送一個新的 Git Tag 時，Azure DevOps 能自動幫我完成**測試、建置、簽署，並將 App 上傳到 TestFlight**，以供後續測試。
...
接著，我們下一篇文章就開始設定 Azure DevOps，讓 CI/CD 的自動化流程能順利地找到目標，並開始為我們上傳建置版本到 TestFlight。
